...
const Skills = ({ skillsRef }: { skillsRef: React.RefObject<HTMLDivElement | null> }) => {
    return (
        <div
            ...
            className='w-full flex flex-col items-center bg-gradient-to-b from-neutral-700 to-transparent gap-5 p-20 md:px-20 border-t-2 border-solid border-neutral-600'
        >
            <h1 className="text-3xl font-extrabold text-primary"><u>SKILLS</u></h1>
